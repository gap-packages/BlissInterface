...
[ [ 1, 2, 4 ], [ 1, 3, 7 ], [ 1, 5, 6 ], [ 2, 3, 5 ], [ 2, 6, 7 ], 
  [ 3, 4, 6 ], [ 4, 5, 7 ] ]
gap> 
gap> bl1:=BipartiteCanonicalLabeling@BlissInterface(7, 7, fano, 0, 0);
...
1
gap> 
gap> bl1c:=BipartiteCanonicalLabeling@BlissInterface(7, 7, fano, 
>     [0,0,1,0,1,1,1], 0);
...
gap> 
gap> bl1cc:=BipartiteCanonicalLabeling@BlissInterface(7, 7, fano, 0, 
>     [0,1,1,1,1,1,1]);
[ [ (3,5)(6,7)(9,10)(13,14), (3,7)(5,6)(11,12)(13,14), 
      (2,4)(5,6)(11,13)(12,14), (1,2)(5,7)(9,11)(10,12) ], 
...
[ [ 2, 5, 6 ], [ 1, 3, 7 ], [ 2, 4, 8 ], [ 3, 5, 9 ], [ 1, 4, 10 ], 
  [ 1, 8, 9 ], [ 2, 9, 10 ], [ 3, 6, 10 ], [ 4, 6, 7 ], [ 5, 7, 8 ] ]
gap> bl2:=GraphCanonicalLabeling@BlissInterface(10, petersen, false, false);
...
S5
gap> 
gap> bl2c:=GraphCanonicalLabeling@BlissInterface(10, petersen, 
...
[ [ 2, 4 ], [ 3, 5 ], [ 1, 6 ], [ 5, 7 ], [ 6, 8 ], [ 4, 9 ], 
  [ 1, 8 ], [ 2, 9 ], [ 3, 7 ] ]
gap> bl3:=GraphCanonicalLabeling@BlissInterface(9, dg, false, true);
...
C3 x S3
gap> bl4:=GraphCanonicalLabeling@BlissInterface(9, dg, false, false);
...
gap> path:=[[2],[3],[]];
[ [ 2 ], [ 3 ], [  ] ]
gap> GraphCanonicalLabeling@BlissInterface(3, path, false, true);
[ [  ], (1,2,3), 1876527224 ]
gap> GraphCanonicalLabeling@BlissInterface(3, path, false, false);
