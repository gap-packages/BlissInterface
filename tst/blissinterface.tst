...
[ [ (3,5)(6,7)(9,10)(13,14), (3,6)(5,7)(9,10)(11,12), (2,3)(4,7)(8,9)(12,13), 
      (1,2)(5,7)(9,11)(10,12) ], (1,7,3,4,5,2,6)(8,14)(9,13)(10,12) ]
gap> g1:=Group(bl1[1]);
Group([ (3,5)(6,7)(9,10)(13,14), (3,6)(5,7)(9,10)(11,12), (2,3)(4,7)(8,9)
  (12,13), (1,2)(5,7)(9,11)(10,12) ])
...
Group([ (3,5)(6,7)(9,10)(13,14), (3,7)(5,6)(11,12)(13,14), (2,4)(5,6)(11,13)
  (12,14), (1,2)(5,7)(9,11)(10,12) ])
gap> StructureDescription(g1c);
"S4"
gap> Orbits(g1c,[1..14]);
...
> ];
[ [ 1, 2 ], [ 2, 3 ], [ 3, 1 ], [ 4, 5 ], [ 5, 6 ], [ 6, 4 ], [ 7, 8 ], 
  [ 8, 9 ], [ 9, 7 ], [ 1, 4 ], [ 4, 7 ], [ 7, 1 ], [ 2, 5 ], [ 5, 8 ], 
  [ 8, 2 ], [ 3, 6 ], [ 6, 9 ], [ 9, 3 ] ]
gap> dg:=List([1..9],i->Filtered([1..9],j->[i,j] in dir_edges));
[ [ 2, 4 ], [ 3, 5 ], [ 1, 6 ], [ 5, 7 ], [ 6, 8 ], [ 4, 9 ], [ 1, 8 ], 
  [ 2, 9 ], [ 3, 7 ] ]
